...
int ObjetoSel = 0;
int rcubo=1,gcubo=1,bcubo=0,rpiramide1=1,gpiramide1=0,bpiramide1=0,rpiramide2=1,gpiramide2=0,bpiramide2=1;
bool fpira1=true,fpira2=true,fcubo=true;
...
void draw_objects()
{
	...
	switch(drawforma){
		...
		case 3:
			...
			glScalef(10,10,10);
			glLoadName(1);
			cubo.draw_solido(rcubo,gcubo,bcubo);
			glPopMatrix();
			...
			*/
			...
			glRotatef(-90,0,0,1);
			glLoadName(2);
			piramide.draw_solido(rpiramide1,gpiramide1,bpiramide1);
			glPopMatrix();
			...
			glRotatef(90,0,0,1);
			glLoadName(3);
			piramide.draw_solido(rpiramide2,gpiramide2,bpiramide2);
			glPopMatrix();
		...
		case 5:
			...
			glPushMatrix();
				...
				dibujar_nave_completa();
			glPopMatrix();
			//tapa de arriba y tapa de abajo
			/*glPushMatrix();
			...
			//dibujar peon con textura automatica
			glPushMatrix();
				carga_materiales(0,1.0f,1.0f,1.0f); //suelo color blanco
			...
			//dibujar la lata con las tapas generadas automaticamente
			glPushMatrix();
...
void draw_scene(void)
{
	...
	draw_axis();
	draw_objects();
	//dibujar_texto();///DA PROBLEMAS CON LA SELECCIÓN
	glutSwapBuffers();
	glutPostRedisplay();
}

//**************************************************************************
//Funcion de selección que procesa los picks en la escena
//***************************************************************************
...
// procesar el cambio de color
	switch (ObjetoSel)
	{
		case 1:
			if(fcubo){
				rcubo=0;gcubo=1;bcubo=0;
			}
			else{
				rcubo=1;gcubo=1;bcubo=0;
			}
			fcubo=!fcubo;
			break;
		case 2:
			if(fpira1){
				rpiramide1=0;gpiramide1=1;bpiramide1=0;
			}
			else{
				rpiramide1=1;gpiramide1=0;bpiramide1=0;
			}
			fpira1=!fpira1;
			break;
		case 3:
			if(fpira2){
				rpiramide2=0;gpiramide2=1;bpiramide2=0;
			}
			else{
				rpiramide2=1;gpiramide2=0;bpiramide2=1;
			}
			fpira2=!fpira2;
...
//**************************************************************************
//Funcion de selección de objetos de la escena
//***************************************************************************
